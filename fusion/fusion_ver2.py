...
ap.add_argument(
    "-m", "--model", type=str, default='res10_300x300_ssd_iter_140000.caffemodel', help="path to Caffe pre-trained model" )
    ...
    with Lepton() as l:
        while True:
            ...
            for i in range( 0, detections.shape[ 2 ] ):
                ...
                facelong = abs( eY - sY )
                facewidth = abs( eX - sX )
                mid = lepton_temp[ int( ( sY + int( ( 1 / 5 ) * facelong ) ) / mFactor ):int( ( eY ) / mFactor ),
                                   int( ( sX + ( 1 / 4 ) * facewidth ) / mFactor ):int( ( eX - ( 1 / 4 ) * facewidth ) /
                                                                                        mFactor ) ]
                midh = lepton_temp[ int( ( sY + int( ( 1 / 5 ) * facelong ) ) /
                                         mFactor ):int( ( eY - int( ( 1 / 2 ) * facelong ) ) / mFactor ),
                                    int( ( sX + ( 2 / 5 ) * facewidth ) / mFactor ):int( ( eX - ( 2 / 5 ) * facewidth ) /
                                                                                         mFactor ) ]
                midl = lepton_temp[ int( ( sY + int( ( 1 / 2 ) * facelong ) ) /
                                         mFactor ):int( ( eY - int( ( 1 / 4 ) * facelong ) ) / mFactor ),
                                    int( ( sX + ( 2 / 5 ) * facewidth ) / mFactor ):int( ( eX - ( 2 / 5 ) * facewidth ) /
                                                                                         mFactor ) ]
                ...
                try:
                    ...
                    if ( int( temp_max ) <= 40 and int( temp_max ) >= 20 and facelong >= 80 and facewidth >= 60 ):
                        ...
                        cv2.rectangle(
                            img_thermal, ( int( sX * ratio / mFactor ), int( sY * ratio / mFactor ) ),
                            ( int( eX * ratio / mFactor ), int( eY * ratio / mFactor ) ), ( 0, 0, 255 ), 1 )
                        display_color = ( 0, 0, 0 )
                        #flag = 0
                        #time_flag = 0
